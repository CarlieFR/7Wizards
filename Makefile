...
rpg.ovl : rpg.c move.c game.c const.c var.c map.c graph.c Merry.asm text.c silence.c 
	$(CC) $(CFLAGS) $(LIBS) rpg.c

battle.ovl : battle.c magic.c const.c var.c graphbattle.c TestMelancholia.asm silence.c
